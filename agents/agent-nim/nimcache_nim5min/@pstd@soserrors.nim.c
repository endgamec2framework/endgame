...
/* Command for C compiler:
   x86_64-w64-mingw32-gcc -c -w -fmax-errors=3 -mno-ms-bitfields -fno-strict-aliasing -DWIN32_LEAN_AND_MEAN -Os -fno-ident   -I/home/kali/.choosenim/toolchains/nim-2.2.10/lib -I/home/kali/c2/agents/agent-nim -o /home/kali/c2/agents/agent-nim/nimcache_nim5min/@pstd@soserrors.nim.c.o /home/kali/c2/agents/agent-nim/nimcache_nim5min/@pstd@soserrors.nim.c */
...
N_LIB_PRIVATE N_NOINLINE(tyObject_OSError__mgJw6oFbS4BLzYIO9ccv8FQ*, newOSError__stdZoserrors_u56)(NI32 errorCode_p0, NimStringV2 additionalInfo_p1);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___stdZoserrors_u101)(tyObject_OSError__mgJw6oFbS4BLzYIO9ccv8FQ* dest_p0);
...
extern TNimTypeV2 NTIv2__mgJw6oFbS4BLzYIO9ccv8FQ_;
static const struct {
...
extern tyProc__aO673xGTLLxou7P7GxoCXA Dl_1509949612_;
extern tyProc__im9buRnIvptJfzdASYMEbBA Dl_1509949620_;
...
{nimErr_ = nimErrorFlag();
	result = TM__1nRK0qvLEFLABF9aZnNtAXQ_3;
	{
		...
		msgbuf_1 = (NI16*)0;
		{
			...
			NimStringV2 T10_;
			T7_ = (NI32)0;
			T7_ = Dl_1509949612_(((NI32)4864), NIM_NIL, errorCode_p0, ((NI32)0), ((void*) (&msgbuf_1)), ((NI32)0), NIM_NIL);
			...
			eqsink___system_u2729((&result), T10_);
			{
				if (!!((msgbuf_1 == ((NI16*) NIM_NIL)))) goto LA13_;
				Dl_1509949620_(((void*) (msgbuf_1)));
			}
LA13_: ;
		}
LA8_: ;
...
N_LIB_PRIVATE N_NOINLINE(tyObject_OSError__mgJw6oFbS4BLzYIO9ccv8FQ*, newOSError__stdZoserrors_u56)(NI32 errorCode_p0, NimStringV2 additionalInfo_p1) {
	tyObject_OSError__mgJw6oFbS4BLzYIO9ccv8FQ* result;
	tyObject_OSError__mgJw6oFbS4BLzYIO9ccv8FQ* T1_;
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	T1_ = NIM_NIL;
	T1_ = (tyObject_OSError__mgJw6oFbS4BLzYIO9ccv8FQ*) nimNewObj(sizeof(tyObject_OSError__mgJw6oFbS4BLzYIO9ccv8FQ), NIM_ALIGNOF(tyObject_OSError__mgJw6oFbS4BLzYIO9ccv8FQ));
	(*T1_).Sup.Sup.Sup.m_type = (&NTIv2__mgJw6oFbS4BLzYIO9ccv8FQ_);
	...
	result = T1_;
	{
		if (!(((NI)0) < additionalInfo_p1.len)) goto LA4_;
		{
			...
			if (!(T8_)) goto LA9_;
			T10_ = (NIM_CHAR*)0;
			T10_ = X5BX5D___system_u8664((&(*result).Sup.Sup.message), ((NI)1));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			T8_ = !(((NU8)((*T10_)) == (NU8)(10)));
LA9_: ;
			if (!T8_) goto LA11_;
...
LA4_: ;
	{
		...
		eqsink___system_u2729((&(*result).Sup.Sup.message), TM__1nRK0qvLEFLABF9aZnNtAXQ_7);
	}
LA15_: ;
	}BeforeRet_: ;
	return result;

...
- **P2P transport** — agent-to-agent mesh similar to Arachne C2, without requiring direct connectivity to the teamserver *(suggested by [d-wreck-w12](https://www.reddit.com/user/d-wreck-w12) on Reddit)*
